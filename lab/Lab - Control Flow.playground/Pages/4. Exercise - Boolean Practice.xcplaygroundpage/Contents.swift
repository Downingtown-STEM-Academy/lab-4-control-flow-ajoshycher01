...
let hasPizza = false
let hasVegan = true
if (hasFish && hasVegan) || (hasPizza && hasVegan) == true{
    print("Let's go!")
}else{
    ...
    if walkingWeather == true{
        ...
        print("I will go outside for a walk")
    }else{
        print ("I will not go outside for a walk")
    }
}
print("For the first set I will go walk outside")
print("For the second set I will not go walk outside")
print("For the third set I will go walk outside")
