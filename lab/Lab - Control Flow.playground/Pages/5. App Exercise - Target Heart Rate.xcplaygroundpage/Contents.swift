...
} else if currentAverage <= targetUpperBound && currentAverage >= targetLowerBound{
...
//print the results from each current average here.
    print ("You need to study more often for one")
    print("You're doing great, but try to push it a bit! for two")
    print("You're right on track for three")
